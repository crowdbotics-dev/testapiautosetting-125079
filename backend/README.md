...
## Project Structure
    ...
    ├── testapiautosetting_125079  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125079`
...
2. Clone this repo and `cd testapiautosetting_125079`
